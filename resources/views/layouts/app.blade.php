...
<body>
    <div id="app">
        ...
        <div class="qr-navbar ng-scope" ng-style="getNavbarStyle()" ng-controller="qrNavbarCtrl" ng-init="route='manage/new'" data-navbar="">
            ...
            <div class="qr-navbar__element">
                <div class="qr-navbar__element qr-navbar__menu qr-navbar__menu__back-button noselect ng-hide" ng-show="route != 'manage/new'" style="display: block;">
                    <a ng-click="goBack($event)" href="/manage">
            ...
            <div class="qr-navbar__element pull-right ng-hide" ng-show="route == 'upgrade/paymentform' || route == 'upgrade/index'">

                <div class="qr-navbar__element">
                    <a href="#" class="call-sales">
            ...
            <div class="qr-navbar__element pull-right" ng-show="route != 'upgrade/index' &amp;&amp; route != 'upgrade/paymentform' &amp;&amp; route != 'create/index' &amp;&amp; route != 'create/new'">
                <div class="qr-navbar__element">
                    <qr-news-bell icon-as-svg="true" status="true" items="[{'id':'20','message':'Wondering how to use QR Codes for your business? See great use cases for retailers, restaurants, packaged goods, nonprofits and more.','updated_at':'2019-04-08 08:02:37','icon':'icon-qr-lightbulb','color':'#4F5557','label':'Choose your business','url':'https://www.qr-code-generator.com/qr-codes-for/?utm_source=app_website&amp;utm_medium=notification_bell&amp;utm_campaign=qrcodesfor'},{'id':'19','message':'You can now find all QR Code customization options under Download - plus, we\'ve added JPG and SVG support for custom QR Codes','updated_at':'2019-02-15 08:35:30','icon':'icon-whitelabeling','color':'#4F5557','label':'','url':''},{'id':'18','message':'How to print QR Codes on flyers, banners, business cards and more','updated_at':'2018-11-30 13:49:07','icon':'icon-graphic-print','color':'#4F5557','label':'View Examples','url':'https://www.qr-code-generator.com/qr-codes-on/?utm_source=app_website&amp;utm_medium=notification_bell&amp;utm_campaign=qrcodeson'}]" mobile-mode="bellMobileMode" class="ng-isolate-scope"><div class="qr-news-bell qr-news-bell--mark" ng-class="getElementClass()"><span class="qr-news-bell__icon" ng-class="getIconClass()" ng-click="click($event)"><svg ng-show="iconAsSvg" width="20px" height="25px" viewBox="0 0 20 25" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class=""><desc>Created with Sketch.</desc><defs><path d="M932,386.375 C933.375,386.375 934.5,385.25 934.5,383.875 L929.5,383.875 C929.5,385.25 930.6125,386.375 932,386.375 Z M939.5,378.875 L939.5,372.625 C939.5,368.7875 937.45,365.575 933.875,364.725 L933.875,363.875 C933.875,362.8375 933.0375,362 932,362 C930.9625,362 930.125,362.8375 930.125,363.875 L930.125,364.725 C926.5375,365.575 924.5,368.775 924.5,372.625 L924.5,378.875 L922,381.375 L922,382.625 L942,382.625 L942,381.375 L939.5,378.875 Z" id="path-1"></path></defs><g id="__Icons" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g id="Artboard" transform="translate(-922.000000, -362.000000)" fill-rule="nonzero"><g id="bell_icon"><use fill-opacity="0.1" fill="#FFFFFF" fill-rule="evenodd" xlink:href="#path-1"></use><path stroke-opacity="0.3" stroke="#FFFFFF" stroke-width="1" d="M933.936143,384.375 L930.062965,384.375 C930.284681,385.237066 931.066437,385.875 932,385.875 C932.926416,385.875 933.712301,385.234495 933.936143,384.375 Z M922.5,381.582107 L922.5,382.125 L941.5,382.125 L941.5,381.582107 L939,379.082107 L939,372.625 C939,368.884848 936.994102,365.980543 933.759343,365.21144 L933.375,365.120057 L933.375,363.875 C933.375,363.113642 932.761358,362.5 932,362.5 C931.238642,362.5 930.625,363.113642 930.625,363.875 L930.625,365.120376 L930.240275,365.21153 C926.994919,365.980465 925,368.870331 925,372.625 L925,379.082107 L922.5,381.582107 Z"></path></g></g></g></svg></span><qr-news-window open="open" mobile-mode="mobileMode" items="items" right="true" class="ng-isolate-scope"><qr-popup open="open" mobile-mode="false" top-offset="" right="true" class="ng-isolate-scope"><div class="qr-popup  qr-popup--right" ng-class="getPopupClasses()" ng-style="{marginTop: topOffset, minWidth: minWidth, marginLeft: leftOffset, zIndex: getPopupZIndex()}" style="z-index: 20000;"><ng-transclude><div class="qr-news-window ng-scope"><h6 class="qr-news-window__title ng-binding">What's new?</h6><span class="qr-news-window__close" ng-click="closeIt()">×</span><div class="qr-news-window__content ps-container ps-theme-default" data-ps-id="b58551f7-39b0-99d1-c663-26da17535d53"><!-- ngRepeat: item in items track by $index --><qr-news-item class="qr-news-window__item ng-scope ng-isolate-scope" ng-repeat="item in items track by $index" value="item"><div class="qr-news-item"><span class="qr-news-item__icon icon-qr-lightbulb" ng-class="value.icon" ng-style="{color: value.color}" style="color: rgb(79, 85, 87);"></span><div class="qr-news-item__message ng-binding">Wondering how to use QR Codes for your business? See great use cases for retailers, restaurants, packaged goods, nonprofits and more.</div><a class="qr-news-item__action ng-binding" href="https://www.qr-code-generator.com/qr-codes-for/?utm_source=app_website&amp;utm_medium=notification_bell&amp;utm_campaign=qrcodesfor" target="_blank" ng-show="value.label &amp;&amp; value.url">Choose your business</a><div class="qr-news-item__date ng-binding">Apr 8, 2019</div></div></qr-news-item><!-- end ngRepeat: item in items track by $index --><qr-news-item class="qr-news-window__item ng-scope ng-isolate-scope" ng-repeat="item in items track by $index" value="item"><div class="qr-news-item"><span class="qr-news-item__icon icon-whitelabeling" ng-class="value.icon" ng-style="{color: value.color}" style="color: rgb(79, 85, 87);"></span><div class="qr-news-item__message ng-binding">You can now find all QR Code customization options under Download - plus, we've added JPG and SVG support for custom QR Codes</div><a class="qr-news-item__action ng-binding ng-hide" href="" target="_blank" ng-show="value.label &amp;&amp; value.url"></a><div class="qr-news-item__date ng-binding">Feb 15, 2019</div></div></qr-news-item><!-- end ngRepeat: item in items track by $index --><qr-news-item class="qr-news-window__item ng-scope ng-isolate-scope" ng-repeat="item in items track by $index" value="item"><div class="qr-news-item"><span class="qr-news-item__icon icon-graphic-print" ng-class="value.icon" ng-style="{color: value.color}" style="color: rgb(79, 85, 87);"></span><div class="qr-news-item__message ng-binding">How to print QR Codes on flyers, banners, business cards and more</div><a class="qr-news-item__action ng-binding" href="https://www.qr-code-generator.com/qr-codes-on/?utm_source=app_website&amp;utm_medium=notification_bell&amp;utm_campaign=qrcodeson" target="_blank" ng-show="value.label &amp;&amp; value.url">View Examples</a><div class="qr-news-item__date ng-binding">Nov 30, 2018</div></div></qr-news-item><!-- end ngRepeat: item in items track by $index --><div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; right: 6px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 0px;"></div></div></div><div class="qr-news-window__actions" ng-switch="isLoading"><!-- ngSwitchWhen: true --><!-- ngSwitchDefault:  --><div ng-switch-default="" class="ng-scope"><button class="qr-news-window__action" type="button" ng-click="loadMore()">Load more</button></div><!-- end ngSwitchWhen: --></div></div></ng-transclude></div><div class="qr-popup__layer" ng-click="onLayerClick()" ng-class="getLayerClasses()" ng-style="{zIndex: getLayerZIndex()}" style="z-index: 19999;"></div></qr-popup></qr-news-window></div></qr-news-bell>
                </div>

                <div class="qr-navbar__element ml-25">
                    <div class="help" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" title="" data-original-title="Customer ID:6108935">
                ...
                <div class="qr-navbar__element">
                    ...
                    <div class="qr-navbar__account-dropdown-container">
                        <div class="qr-navbar__scrollable-container ps-container ps-theme-default" data-ps-id="d8a0effc-e8be-1b88-d31c-6e8f6f0871b5">
                            <ul class="qr-navbar__dropdown__container">
                                ...
                                <li>
                                    <a href="/api/?from=options">
                                        API Keys                            <i class="icon-options"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="/upgrade/?from=options">
            ...
            <div class="qr-navbar__trial-banner">
                <!-- ngIf: isTrialMessageVisible() && route != 'upgrade/index' && route != 'upgrade/paymentform' && route != 'create/index' && route != 'create/new' --><qr-trial-left ng-if="isTrialMessageVisible() &amp;&amp; route != 'upgrade/index' &amp;&amp; route != 'upgrade/paymentform' &amp;&amp; route != 'create/index' &amp;&amp; route != 'create/new'" trial-date="getTrialDate()" class="ng-scope ng-isolate-scope" style=""><div class="qr-trial-left"><div class="qr-trial-left__days-left ng-binding" ng-bind="trialMessage">Free Trial ends in 13 days</div><div class="qr-trial-left__upgrade-link"><a ng-href="/upgrade/?trial=sidebar" ng-bind="::upgradeLabel" data-trial-link="" target="_blank" class="ng-binding" href="/upgrade/?trial=sidebar">Upgrade</a></div></div></qr-trial-left><!-- end ngIf: isTrialMessageVisible() && route != 'upgrade/index' && route != 'upgrade/paymentform' && route != 'create/index' && route != 'create/new' -->
            </div>
        </div>
